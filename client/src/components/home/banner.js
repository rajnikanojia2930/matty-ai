...
function Banner() {
  ...
  return (
    <div className="rounded-xl overflow-hidden bg-gradient-to-r from-[#245B6C] via-[#245B6C] to-[#245B6C] text-white p-4 sm:p-6 md:p-8 text-center">
      ...
      <h2 className="text-sm sm:text-base md:text-lg font-bold mb-4 sm:mb-6 max-w-2xl mx-auto">
        Design eye-catching Canva designs
      </h2>
      <Button
        onClick={handleCreateNewDesign}
        className="text-[#2B7A70] bg-white hover:bg-gray-100 rounded-lg px-4 py-2 sm:px-6 sm:py-2.5"
      >
